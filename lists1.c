...
/**
 * list_to_string_array - Returns an array of strings from the list's str field.
...
/**
 * print_string_list - Prints all elements of a list_t linked list.
 * @h: Pointer to the first node.
 *
 * Return: Size of the list.
 */
 ...
 */
list_t *find_find_node_starts_with(list_t *node, char *prefix, char c)
{
	char *p = NULL;
