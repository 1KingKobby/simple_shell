...
/**
 * add_node_start - Add a node to the start of the list.
 ...
 */
list_t *add_node_start_end(list_t **head, const char *str, int num)
{
...
/**
 * free_string_list - Free all nodes of a string list.
