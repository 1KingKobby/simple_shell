...
/**
 * my_history - Display the history list, one command per line, preceded
 ...
 * @info: Pointer to a parameter structure.
 * @str: The string representing the alias.
 *
 * Return: Always 0 on success, 1 on error
 */

int unset_aliases(info_t *info, char *str)
{
	char *p, c;
	int ret;
...
/**
 * my_aliases - copies the alias builtin (man alias)
 * @info: Structure containing potential arguments. Used to maintain
 *          constant function prototype.
 *  Return: Always 0
 */
int my_aliases(info_t *info)
{
	int i = 0;
	char *p = NULL;
	list_t *node = NULL;
